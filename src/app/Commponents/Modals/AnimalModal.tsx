...
const AddAnimalModal = ({ isVisible, onClose }: AddAnimalModalProps) => {
    ...
    const handleAnimalCategoryChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    return (
        ...
        >
            <div className="bg-white p-4 rounded-lg shadow-lg">
                ...
                <form>
                    <div className="mb-2">
                        <label htmlFor="animalName" className="block text-sm font-medium text-gray-700">
                            Animal Name
                        </label>
                        <input
                            type="text"
                    ...
                    <div className="mb-2">
                        <label htmlFor="animalImage" className="block text-sm font-medium text-gray-700">
                            Image
                        </label>
                        <input
                    ...
                    <div className="mb-2">
                        <label htmlFor="animalCategory" className="block text-sm font-medium text-gray-700">
                            Category
                        </label>
                        <select
                            id="animalCategory"
